"""
Модуль viewsService.py
Сторонние библиотеки, используемые в модуле:
shortcuts – библиотека переадресации по маршрутам системы;
models - бибилиотека для работы с моделями;
...
get_services - получение информации об услуге;
updateService - обновление информации об услуге;
add_service - добавление информации об услуге;
newService - создание информации об услуге;
deleteService - удаление информации об услуге;
searchService - поиск нужной услуги по критериям;
index - обработка страницы об услугах;

Основные переменные:
initial_services - заполненные поля форм с услугами;
all_services - все услуги из БД;
values - новая информация об услуге;
service - конкретная услуга;
value - значения из формы;
context - данные передаваемые пользователю;
status - статус добавления услуги;
initial_clients - услуги, подходящие критериям поиска;
search - критерий поиска;
search_list - набор услуг, удовлетворяющих критерии поиска;
user_form - форма с информацией об услуге;
