...
get_user_info - функция, возвращающая информацию о сотруднике;
send_message - функция, отправляющая сообщения на почту;
...
addr_from - почта отправитель письма;
password - пароль от почты отправителя;
msg - экземпляр отправляемого сообщения;
server - объект SMTP;
"""
...
def send_message(addr_to, message):
    ...
    msg['Subject'] = 'КИБЕР КЛАСС'  # Тема сообщения
