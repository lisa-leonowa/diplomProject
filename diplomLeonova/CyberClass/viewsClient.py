...
check_fields - проверка корректности заполненых полей;
add_client - добавление информации о клиенте;
deleteClient - удаление информации о клиенте;
newClient - добавление информации о клиенте;
updateClient - обновление информации о клиенте;
get_clients - получение всех клиентов;
searchClient - поиск клиента по критерию;
mail_confirmation - подтверждение электронной почту;
index - обработка страницы работы с клиентами;

Основные переменные:
last_name - фамилия клиента;
first_name - имя клиента;
full_name - отчество клиента;
phone - номер телефона клиента;
check - состояние проверки информации о клиенте;
cod - код подтверждения;
value - получение информации из формы клиента;
context - данные передаваемые пользователю;
status - статус добавления сотрудника;
form_new_client - форма добавление нового клиента;
client - все клиенты из БД;
values - значения из формы клиента;
initial_clients - формы клиентов;
all_clients - информация о клиентах из БД;
search - получение критерия поиска;
search_list_last_name - критерий поиска по фамилии;
search_list_phone - критерий поиска по номеру телефона;
search_list - клиенты подходящие под критерии поиска;
form - форма доваления нового клиента;
user_form - информация для изменения информации о клиенте;
"""
