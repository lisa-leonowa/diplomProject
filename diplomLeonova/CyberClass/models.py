...
models – модуль, позволяющий работать с моделями;
ModelForm - модуль, позволяющий создавать формы на базе моделей;

Классы, используемые в модуле:
Clients - хранит информацию о клиентах;
Services - хранит информацию об услугах;
Deals - хранит информацию о покупках;
Employees - хранит информацию о сотрудников;
ClientsForm - форма клиента;
ServicesForm - форма услуги;
DealsForm - форма покупки;
EmployeesForm - форма сотрудника;
"""
