"""
Модуль viewsStatistics.py
Сторонние библиотеки, используемые в модуле:
forCyberClass – самостоятельно написанный модуль с вспомогательными функциями;
os - библиотека для работы с операционной системой;
matplotlib - библиотека для создания графика статистики;
shortcuts - библиотека перехода по маршрутам системы;

Функции, используемые в модуле:
index - функция, обрабатывающая страницу статистики;

Основные переменные:
services - все услуги, используемые для создания статистики;
purchased_services - информация о купленных услугах;
names - наименование столбцов диаграммы;
values - значения столбцов диаграммы;
bar1 - слой с сеткой диаграммы;
my_path - файл для сохранения картинки статистики;
"""
